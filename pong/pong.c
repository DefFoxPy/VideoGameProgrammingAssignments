...
{
    init_paddle(&pong->player1, PADDLE_X_OFFSET, TABLE_HEIGHT/2, PADDLE_WIDTH, PADDLE_HEIGHT, IA_PLAYER_1);
    init_paddle(&pong->player2, TABLE_WIDTH - PADDLE_WIDTH - PADDLE_X_OFFSET, TABLE_HEIGHT/2, PADDLE_WIDTH, PADDLE_HEIGHT, IA_PLAYER_2);
