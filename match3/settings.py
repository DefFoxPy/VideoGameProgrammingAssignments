...
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_UP, 'mup')
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_DOWN, 'mdown')
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_LEFT, 'mleft')
input_handler.InputHandler.set_mouse_motion_action(input_handler.MOUSE_MOTION_RIGHT, 'mright')
